...
const onViewCompareIntelRequested = (e: string) =>
  changeMenuState({ state: "intel", compareWithPlayerId: e });

const onShipTransferRequested = (e: string) =>
  changeMenuState({ state: "shipTransfer", carrierId: e });

const onShipsTransferred = (e: string) =>
  changeMenuState({ state: "carrierDetail", carrierId: e });

const onOpenCarrierDetailRequested = (e: string) =>
  changeMenuState({ state: "carrierDetail", carrierId: e });

const onOpenStarDetailRequested = (e: string) =>
  changeMenuState({ state: "starDetail", starId: e });

const onOpenPlayerDetailRequested = (e: string) =>
  changeMenuState({ state: "player", playerId: e });

const onOpenTradeRequested = (e: string) =>
  changeMenuState({ state: "trade", playerId: e });

const onEditWaypointsRequested = (e: string) =>
  changeMenuState({ state: "carrierWaypoints", carrierId: e });

const onEditWaypointRequested = ({
  carrierId,
  waypoint,
}: {
  carrierId: string;
  waypoint: CWTp<string>;
}) => changeMenuState({ state: "carrierWaypointDetail", carrierId, waypoint });

const onViewHireCarrierSpecialistRequested = (e: string) =>
  changeMenuState({ state: "hireSpecialistCarrier", carrierId: e });

const onViewHireStarSpecialistRequested = (e: string) =>
  changeMenuState({ state: "hireSpecialistStar", starId: e });

const onBuildCarrierRequested = (e: string) =>
  changeMenuState({ state: "buildCarrier", starId: e });

const onCarrierRenameRequested = (e: string) =>
...
const onOpenPurchasePlayerBadgeRequested = (e: string) =>
  changeMenuState({ state: "playerBadgeShop", recipientPlayerId: e });

const onOpenReportPlayerRequested = (args: ReportPlayerArgs) =>
  changeMenuState({ state: "reportPlayer", args });

const onViewColourOverrideRequested = (e: string) =>
  emit("onViewColourOverrideRequested", e);
